...
// POST /api/lessons/generate - Generate lesson from document
export async function POST(request: NextRequest) {
  try {
    ...
    const backendResponse = await fetch(`${getBackendUrl()}/lessons/generate`, {
      method: 'POST',
      headers: {
    ...
    console.error('[api/lessons/generate] POST proxy failed:', error);
