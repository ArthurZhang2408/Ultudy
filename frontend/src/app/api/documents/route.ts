...
// GET /api/documents - List all documents (with optional course_id filter)
export async function GET(request: NextRequest) {
  try {
    ...
    const url = new URL(`${getBackendUrl()}/documents`);
    ...
    console.error('[api/documents] GET proxy failed:', error);
