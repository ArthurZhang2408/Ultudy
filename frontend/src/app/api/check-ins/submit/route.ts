...
// POST /api/check-ins/submit - Submit check-in answer
export async function POST(request: NextRequest) {
  try {
    ...
    const backendResponse = await fetch(`${getBackendUrl()}/check-ins/submit`, {
      method: 'POST',
      headers: {
    ...
    console.error('[api/check-ins/submit] POST proxy failed:', error);
