...
// POST /api/study-sessions/:id/complete - Complete a study session
export async function POST(
  ...
  try {
    ...
    const backendResponse = await fetch(
      `${getBackendUrl()}/study-sessions/${params.id}/complete`,
      {
        method: 'POST',
        headers: {
    ...
    console.error('[api/study-sessions/:id/complete] POST proxy failed:', error);
