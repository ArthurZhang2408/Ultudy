...
function PreLaunchPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-100/40 via-transparent to-transparent dark:from-primary-900/20" />
      <div className="absolute bottom-0 right-0 -z-10 w-[500px] h-[500px] bg-primary-200/30 dark:bg-primary-800/10 rounded-full blur-3xl" />
      <div className="absolute top-20 left-0 -z-10 w-[500px] h-[500px] bg-primary-100/20 dark:bg-primary-900/10 rounded-full blur-3xl" />
...
function LandingPage() {
  return (
    <div className="space-y-20 pb-16 relative overflow-hidden">
      {/* Elegant layered background */}
      <div className="absolute inset-0 -z-10 bg-neutral-50 dark:bg-neutral-950" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-100/40 via-transparent to-transparent dark:from-primary-900/20" />
      <div className="absolute bottom-0 right-0 -z-10 w-[500px] h-[500px] bg-primary-200/30 dark:bg-primary-800/10 rounded-full blur-3xl" />
