    ...
    <div className="space-y-20 pb-16">
      ...
      <section className="relative py-20 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-success-200/20 rounded-full blur-3xl" />
        </div>
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-neutral-900 max-w-4xl mx-auto leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/courses"
              className="inline-flex items-center gap-2 px-8 py-4 bg-primary-600 text-white text-lg font-semibold rounded-xl hover:bg-primary-700 shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5"
            >
              Get Started Free
            ...
            <Link
              href="/upload"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-neutral-700 text-lg font-semibold rounded-xl border-2 border-neutral-300 hover:border-primary-300 hover:bg-primary-50 transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="space-y-12">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group bg-white rounded-2xl border border-neutral-200 p-8 shadow-soft hover:shadow-large hover:-translate-y-1 transition-all duration-200">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 mb-2">Organize Your Courses</h3>
          ...
          <div className="group bg-white rounded-2xl border border-neutral-200 p-8 shadow-soft hover:shadow-large hover:-translate-y-1 transition-all duration-200">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 mb-2">Interactive Learning</h3>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <div className="group bg-white rounded-2xl border border-neutral-200 p-8 shadow-soft hover:shadow-large hover:-translate-y-1 transition-all duration-200">
            ...
            <h3 className="text-xl font-semibold text-neutral-900 mb-2">Track Your Mastery</h3>
            <p className="text-neutral-600 leading-relaxed">
      ...
      <section className="bg-gradient-to-br from-primary-50 to-white rounded-3xl border border-primary-100 p-8 md:p-12">
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="relative bg-white rounded-xl p-6 border border-neutral-200 shadow-soft">
                <div className="absolute -top-4 -left-4 w-10 h-10 bg-primary-600 text-white rounded-full flex items-center justify-center text-lg font-bold shadow-md">
                  {item.step}
                </div>
                <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center text-primary-700 mb-3 mt-2">
                  {item.icon}
                </div>
      ...
      {/* CTA Section */}
      <section className="text-center bg-gradient-to-r from-primary-600 to-primary-800 rounded-3xl p-12 md:p-16 text-white shadow-large">
        <div className="space-y-6">
          ...
          <Link
            href="/courses"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary-700 text-lg font-semibold rounded-xl hover:bg-primary-50 shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5"
          >
